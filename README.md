...
| `PROJECT_NAME/`       | A Python directory that contains code for your Dagster repository                 |
| `PROJECT_NAME_tests/` | A Python directory that contains tests for `PROJECT_NAME`                      |
...
Tests can be found in `PROJECT_NAME_tests` and are run with the following command:

```bash
pytest PROJECT_NAME_tests
```

As you create Dagster ops and graphs, add tests in `PROJECT_NAME_tests/` to check that your
